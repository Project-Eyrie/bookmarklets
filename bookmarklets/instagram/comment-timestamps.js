...
(function() {
  ...
  // Finds button elements whose text matches any of the given regex patterns
  ...
  // Adds timestamp badges to all time elements on the page
  ...
  // Orchestrates comment expansion and timestamp badge insertion
  function run() {
    msg('Starting...');
