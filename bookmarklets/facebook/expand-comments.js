...
(function() {
  ...
  // Prepends a status message to the log window
  function msg(text) {
  ...
  // Sequentially clicks an array of elements with a delay between each
  ...
  // Finds visible button elements whose text matches any of the given regex patterns
  ...
  // Switches the comment filter to "All comments" if not already selected
  ...
  // Returns elements that load additional comments
  ...
  // Returns elements that load additional replies
  ...
  // Returns "See more" truncation buttons
  ...
  // Repeatedly finds and clicks expandable elements until none remain or max rounds reached
  ...
  // Orchestrates the full comment expansion sequence
  function run() {
    msg('Starting...');
