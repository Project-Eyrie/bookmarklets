...
(function() {
  ...
  // Creates a draggable overlay window and returns the body element
  ...
  // Renders creation and modification timestamps in the output window
  ...
  // Attempts to extract review timestamps from APP_INITIALIZATION_STATE
  ...
  // Falls back to the Google Maps API to fetch review timestamps
