// Creates a reusable draggable overlay window for OSINT bookmarklet output

// Builds and appends a fixed-position window with a draggable title bar, returning the win, body, and bar elements
